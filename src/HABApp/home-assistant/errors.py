...
# Connection errors
# ----------------------------------------------------------------------------------------------------------------------
class HomeassistantConnectionNotSetUpError(Exception):
    pass


class HomeassistantDisconnectedError(Exception):
    pass


class HomeassistantNotReadyYet(Exception):
    pass


class ExpectedSuccessFromHomeassistant(Exception):
    pass
